...
lab.before((done) => {
  ...
  const plugins = [HapiAuthBasic, HapiAuthCookie, ModelsPlugin, AuthPlugin, BioDesignPlugin];
...
lab.experiment('BioDesign Plugin Create', () => {
  ...
  lab.test('it returns an error when create fails', (done) => {
    ...
    stub.BioDesign.create = function (name, description, userId, displayId, imageURL, subBioDesignIds, superBioDesignId, type, application, callback) {
