...
const ModulePlugin = require('../../../server/api/modules');
...
lab.before((done) => {
  ...
  const proxy = {};
  proxy[Path.join(process.cwd(), './server/models/module')] = stub.Module;
  ...
  const plugins = [HapiAuthBasic, HapiAuthCookie, ModelsPlugin, AuthPlugin, ModulePlugin];
...
lab.experiment('Module Plugin Result List', () => {
  ...
  lab.test('it returns an error when paged find fails', (done) => {
    ...
    stub.Module.pagedFind = function () {
...
lab.experiment('Module Plugin Read', () => {

  lab.beforeEach((done) => {

    request = {
      method: 'GET',
      url: '/module/93EP150D35',
      credentials: AuthenticatedUser
    };
  ...
  lab.test('it returns an error when find by id fails', (done) => {
    ...
    stub.Module.findById = function (id, callback) {
...
lab.experiment('Module Plugin Delete', () => {
  ...
  lab.test('it returns an error when delete by id fails', (done) => {
    ...
    stub.Module.findByIdAndDelete = function (id, callback) {
...
lab.experiment('Module Plugin Create', () => {
  ...
  lab.test('it returns an error when create fails', (done) => {
    ...
    stub.Module.findOne = function (conditions, callback) {

      callback();
    };

    stub.Module.create = function (name, description, userId, displayId, bioDesignId, role, submoduleIds, callback) {
